...
const DashboardTree = () => {
    ...
    const renderRectSvgNode = ({ nodeDatum, toggleNode }) => {
      console.log(nodeDatum);
        ...
        else if(nodeDatum.itemtype === "step5"){
          backgroundColor = "#5D6E1E";
        }
        else if(nodeDatum.itemtype === "step6"){
          backgroundColor = "#BD3B1B";
        }
        else if(nodeDatum.itemtype === "step7"){
                    ...
                    <g id="Navigation" transform="translate(765.154 722.395)" >
                      <g id="_-Round-_-Navigation-_-arrow_back_ios" data-name="-Round-/-Navigation-/-arrow_back_ios" transform="translate(0 0)">
                        <g id="Group_277" data-name="Group 277">
                          <path id="_-Icon-Color" onClick={toggleNode} stroke-width="0" data-name="🔹-Icon-Color" d="M.338,16.864a1.145,1.145,0,0,0,1.622,0L9.578,9.247a.913.913,0,0,0,0-1.292L1.96.337A1.147,1.147,0,0,0,.338,1.959L6.974,8.605.329,15.251A1.143,1.143,0,0,0,.338,16.864Z" transform="translate(0 0)" fill="#fff" fill-rule="evenodd"/>
                        </g>
                      </g>
                    </g>
                  </>
                  ...
                  <>
                    ...
                    <g id="Navigation" transform="translate(695.001 720)">
                      <g id="_-Round-_-Navigation-_-arrow_back_ios" data-name="-Round-/-Navigation-/-arrow_back_ios">
                        <g id="Group_277" data-name="Group 277">
                          <path id="_-Icon-Color"  onClick={toggleNode} stroke-width="0" data-name="🔹-Icon-Color" d="M9.508,16.864a1.145,1.145,0,0,1-1.622,0L.268,9.247a.913.913,0,0,1,0-1.292L7.885.337A1.147,1.147,0,0,1,9.508,1.959L2.871,8.605l6.646,6.646A1.143,1.143,0,0,1,9.508,16.864Z" transform="translate(5.727 2.395)" fill="#fff" fill-rule="evenodd"/>
                        </g>
                      </g>
                    </g>            
                  </>
